...
<?php  
 ...
 $sql = "SELECT * FROM submission WHERE userName='$userName'";
                     ...
                     <table id="submissionData" class="table table-striped table-bordered">  
                          ...
                          {  
                            ...
                            echo '<tr>
                                ...
                                <td>';
                            echo "<a href='../submitAndRunCode/problemSubmitPage.php?problemId=".$row['problemId']."&contestId=$contestId"."' target='_blank'>".$row['problemName']."</a>".'</td>';
