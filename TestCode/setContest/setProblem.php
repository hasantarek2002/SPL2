...
function showTable() {
	...
	if (mysqli_num_rows($result) > 0) {
	    ...
	    echo "<table border='1' align='center'><tr> <th>problem id</th><th>contest id</th> <th>problem name</th> <th>Time Limit</th>  <th>input file</th> <th>Solution file</th><th>Question file</th> <th>Delete</th></tr>";
...
if(isset($_POST["finish"])) {
	...
	header("location:showFinalProblemListForAContestForAdmin.php?contestId=$contestId");
	//showTable();	    
}
...
<body>
	...
	<form name="fileUpload" onsubmit="return validateExtensionOfFile()" method="post" enctype="multipart/form-data">
		...
		<input type="submit" value="Add another problem" name="submit"> </input>
		<input type="submit" value="Finish" name="finish"> </input>
	</form>
